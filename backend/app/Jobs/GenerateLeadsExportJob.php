...
class GenerateLeadsExportJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        // CSV é muito mais leve que XLSX; manter limites conservadores
        ...
        Config::set('excel.cache.batch.memory_limit', 16384);
        ...
        try {
            ...
            // escreve CSV diretamente (tmp -> final)
            $tmpPath = "{$dir}/{$this->token}.tmp.csv";
            Excel::store(new LeadsExport($query, $columns), $tmpPath, $diskName, ExcelWriter::CSV);
