    ...
    public function __invoke(Request $request): Response
    {
        ...
        $query = DB::table('vendeai_newcorban_proposal_attempts as attempts')
            ...
            ->select([
                ...
                'leads.simulation_liquid_value',
                'leads.simulation_number_of_payments',
                'leads.simulation_installment_value',
                'leads.simulation_monthly_fee',
                'leads.simulation_table_name',
                'leads.simulation_table_id',
                'leads.simulation_best_liquid_value',
                'leads.simulation_best_table_id',
                'leads.simulation_received_at',
                'leads.proposal_id',
                'leads.proposal_number',
                'leads.proposal_bank',
                'leads.proposal_product',
                'leads.proposal_status',
                'leads.previous_proposal_status',
                'leads.proposal_liquid_value',
                'leads.proposal_gross_value',
                'leads.proposal_number_of_payments',
                'leads.proposal_installment_value',
                'leads.proposal_table_name',
                'leads.proposal_table_id',
                'leads.proposal_formalization_link',
                'leads.proposal_created_at',
            ...
            $query
                ...
                ->through(fn (object $row): array => [
                    ...
                    'lead' => [
                        ...
                        'simulation_liquid_value' => $row->simulation_liquid_value,
                        'simulation_number_of_payments' => $row->simulation_number_of_payments === null ? null : (int) $row->simulation_number_of_payments,
                        'simulation_installment_value' => $row->simulation_installment_value,
                        'simulation_monthly_fee' => $row->simulation_monthly_fee,
                        'simulation_table_name' => $row->simulation_table_name,
                        'simulation_table_id' => $row->simulation_table_id,
                        'simulation_best_liquid_value' => $row->simulation_best_liquid_value,
                        'simulation_best_table_id' => $row->simulation_best_table_id,
                        'simulation_received_at' => $this->iso($row->simulation_received_at),
                        'proposal_id' => $row->proposal_id,
                        'proposal_number' => $row->proposal_number,
                        'proposal_bank' => $row->proposal_bank,
                        'proposal_product' => $row->proposal_product,
                        'proposal_status' => $row->proposal_status,
                        'previous_proposal_status' => $row->previous_proposal_status,
                        'proposal_liquid_value' => $row->proposal_liquid_value,
                        'proposal_gross_value' => $row->proposal_gross_value,
                        'proposal_number_of_payments' => $row->proposal_number_of_payments === null ? null : (int) $row->proposal_number_of_payments,
                        'proposal_installment_value' => $row->proposal_installment_value,
                        'proposal_table_name' => $row->proposal_table_name,
                        'proposal_table_id' => $row->proposal_table_id,
                        'proposal_formalization_link' => $row->proposal_formalization_link,
                        'proposal_created_at' => $this->iso($row->proposal_created_at),
                        'proposal_status_updated_at' => $this->iso($row->proposal_status_updated_at),
                    ],
                    'proposal' => [
                        'proposal_id' => $row->proposal_id,
                        'proposal_number' => $row->proposal_number,
                        ...
                        'previous_status' => $row->previous_proposal_status,
                        'liquid_value' => $row->proposal_liquid_value,
                        'gross_value' => $row->proposal_gross_value,
                        'number_of_payments' => $row->proposal_number_of_payments === null ? null : (int) $row->proposal_number_of_payments,
                        'installment_value' => $row->proposal_installment_value,
                        'table_name' => $row->proposal_table_name,
                        'table_id' => $row->proposal_table_id,
                        'formalization_link' => $row->proposal_formalization_link,
                        'created_at' => $this->iso($row->proposal_created_at),
                        'status_updated_at' => $this->iso($row->proposal_status_updated_at),
                    ],
                ])
        );
    }
