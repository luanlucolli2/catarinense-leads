...
final class LeadExportColumns
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'saldo' => ['label' => 'Saldo', 'formatter' => 'float'],
            'libera' => ['label' => 'Libera', 'formatter' => 'float'],
            ...
            'contracts_count' => ['label' => 'Qtde de Contratos', 'formatter' => 'int'],
            ...
            'valor_renda' => ['label' => 'CLT Renda Total', 'formatter' => 'float'],
            'valor_base_margem' => ['label' => 'CLT Base de Margem', 'formatter' => 'float'],
            'margem_disponivel' => ['label' => 'CLT Margem Disponível', 'formatter' => 'float'],
            'valor_max_prestacao' => ['label' => 'CLT Valor Máx. Prestação', 'formatter' => 'float'],
            ...
            'qtd_emprestimos_ativos_suspensos' => ['label' => 'CLT Qtde Empréstimos Ativos/Suspensos', 'formatter' => 'int'],
