                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-logout">Log the user out of the application.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-leads">
                                <a href="#endpoints-GETapi-leads">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-leads">
                                <a href="#endpoints-POSTapi-leads">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-leads--id-">
                                <a href="#endpoints-GETapi-leads--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-leads--id-">
                                <a href="#endpoints-PUTapi-leads--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-leads--id-">
                                <a href="#endpoints-DELETEapi-leads--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-leads">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-leads">Store a newly created resource in storage.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-leads--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/leads/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/leads/architecto"
);
...
<p>The ID of the lead. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-leads--id-">Update the specified resource in storage.</h2>
...
<p>The ID of the lead. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-leads--id-">Remove the specified resource from storage.</h2>
