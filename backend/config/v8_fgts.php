...
return [
    ...
    'job' => [
        ...
        'phase2_page_limit' => (int) env('V8_FGTS_PHASE2_PAGE_LIMIT', 50),
        'phase2_search_fallback_limit' => (int) env('V8_FGTS_PHASE2_SEARCH_FALLBACK_LIMIT', 50),
        'phase2_search_fallback_round_start' => (int) env('V8_FGTS_PHASE2_SEARCH_FALLBACK_ROUND_START', 3),
        'phase2_search_fallback_pending_threshold' => (int) env('V8_FGTS_PHASE2_SEARCH_FALLBACK_PENDING_THRESHOLD', 50),
        'phase2_plain_search_last_resort_round_start' => (int) env('V8_FGTS_PHASE2_PLAIN_SEARCH_LAST_RESORT_ROUND_START', 25),
