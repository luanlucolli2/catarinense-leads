import { Home, LogOut, Menu, FileText, ClipboardList, Search } from "lucide-react";
...
const Sidebar = ({ className, isCollapsed, onToggle }: SidebarProps) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      active:
        location.pathname === "/importacoes/historico" ||
        location.pathname.startsWith("/importacoes/historico"),
    },
    {
      name: "Consulta CLT",
      icon: Search,
      path: "/clt/consulta",
      active:
        location.pathname === "/clt/consulta" ||
        location.pathname.startsWith("/clt/consulta"),
    },
    {
      name: "Sair",
      icon: LogOut,
