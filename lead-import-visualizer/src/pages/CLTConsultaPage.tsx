  ...
  const v8ItemsWithOverlay: V8ConsultJobListItem[] = useMemo(() => {
    ...
    return v8Items.map((i) => {
      ...
      return {
        ...
        executor: watchedV8Job.executor ?? i.executor,
        ...
        phase1_submitted_count: watchedV8Job.phase1_submitted_count ?? i.phase1_submitted_count,
        phase1_not_eligible_count: watchedV8Job.phase1_not_eligible_count ?? i.phase1_not_eligible_count,
        phase1_errors_count: watchedV8Job.phase1_errors_count ?? i.phase1_errors_count,
        phase2_approved_count: watchedV8Job.phase2_approved_count ?? i.phase2_approved_count,
        phase2_not_approved_count: watchedV8Job.phase2_not_approved_count ?? i.phase2_not_approved_count,
        phase2_errors_count: watchedV8Job.phase2_errors_count ?? i.phase2_errors_count,
